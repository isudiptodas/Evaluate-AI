        ...
        <>
            <div className={`overflow-hidden w-60 h-full bg-white rounded-md lg:rounded-lg flex flex-col  ${className}`}>
                ...
                <div className={`w-full px-2 py-2 h-auto flex flex-col justify-start items-start`}>
                    <p className={`w-full bg-white border-2 border-purple-600 text-black rounded-full cursor-pointer hover:opacity-80 duration-200 ease-in-out text-center active:scale-95 py-2`}>View Feedback</p>
                </div>
            </div>
        </>
    )
